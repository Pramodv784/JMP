...
public class CalculatorActivity extends AppCompatActivity {
    ...
    public void clickNumberDisplay(View v) {
        ...
        Toast.makeText(CalculatorActivity.this, "Copied result to clipboard", Toast.LENGTH_SHORT).show();
    }
    ...
    public void clickOperationsDisplay(View v) {
        ...
        clipboard.setPrimaryClip(clip);
        Toast.makeText(CalculatorActivity.this, "Copied operations to clipboard", Toast.LENGTH_SHORT).show();
    }
