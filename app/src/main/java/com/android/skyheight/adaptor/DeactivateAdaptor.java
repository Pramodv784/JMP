...
import com.android.skyheight.activity.DeactivateActivity;
...
public class DeactivateAdaptor extends RecyclerView.Adapter<DeactivateAdaptor.ViewHolder> {
    private Context context;
    private ArrayList<UserList> userlist;
    List<UserList> list2;


    public DeactivateAdaptor(Context context, ArrayList<UserList> userlist, List<UserList> list2){
    ...
    @NonNull
    @Override
    public DeactivateAdaptor.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DeactivateAdaptor.ViewHolder holder, int position) {
        final UserList mylist=userlist.get(position);
        holder.user_name.setText(mylist.getUser_name());
        holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, DeactivateActivity.class);
